...
for fpath in html_files:
    ...
    # Sugerir la palabra clave principal según el título y H1
    # Extraer frase representativa del título
...
# Mapeo de keywords específicas por página para probar con SerpApi
keyword_map = {
