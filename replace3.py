...
def process_file(file_path):
    ...
    replacements = [
        ...
        (r'(?i)Licenciatura\s+con\s+validez\s+SEP', 'Licenciatura con preparación para admisión'),
        ...
        (r'(?i)oficial\s+SEP', 'preparación para admision'),
...
print(f"Processed {count} HTML files in total.")
